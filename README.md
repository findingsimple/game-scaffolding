...
[![CI](https://github.com/findingsimple/game-scaffolding/actions/workflows/ci.yml/badge.svg)](https://github.com/findingsimple/game-scaffolding/actions/workflows/ci.yml)
[![Web](https://github.com/findingsimple/game-scaffolding/actions/workflows/web.yml/badge.svg)](https://github.com/findingsimple/game-scaffolding/actions/workflows/web.yml)
[![Release](https://github.com/findingsimple/game-scaffolding/actions/workflows/release.yml/badge.svg)](https://github.com/findingsimple/game-scaffolding/actions/workflows/release.yml)
...
its rules, physics, UI and screen flow, — **Coin Dash** — that shows every convention in action.

**Play the example:** <https://findingsimple.github.io/game-scaffolding/>
...
```sh
git clone git@github.com:findingsimple/game-scaffolding.git
cd game-scaffolding
make setup     # installs Godot 4.7.2, gdtoolkit, pre-commit, export templates (asks first)
make run       # play Coin Dash
